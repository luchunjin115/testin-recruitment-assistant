...
class ScreeningResultVersionModelTest(TestCase):
    def test_screening_result_requires_application_and_resume(self) -> None:
        table = ScreeningResult.__table__

        self.assertFalse(table.c.application_id.nullable)
        self.assertFalse(table.c.resume_id.nullable)
    ...
    def test_all_postgresql_mappers_and_stage7_tables_configure_together(self) -> None:
        configure_mappers()
