...
class ResumeDocxExtractorTest(TestCase):
    ...
    def test_rejects_archive_with_too_many_members(self) -> None:
        ...
        with patch(
            "app.services.rebuilt.resume_docx_extractor.MAX_DOCX_ARCHIVE_ENTRIES",
            1,
        ):
    ...
    def test_rejects_archive_with_excessive_uncompressed_size(self) -> None:
        ...
        with patch(
            "app.services.rebuilt.resume_docx_extractor.MAX_DOCX_UNCOMPRESSED_BYTES",
            100,
        ):
    ...
    def test_rejects_extracted_text_over_limit(self) -> None:
        ...
        with patch(
            "app.services.rebuilt.resume_docx_extractor.MAX_EXTRACTED_CHARACTERS",
            4,
        ):
