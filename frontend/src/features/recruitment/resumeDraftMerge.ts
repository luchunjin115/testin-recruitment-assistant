import type { RecruitmentCandidateCreateInput } from './services/candidates';
...
export type ResumeBasicInfoMergeResult = {
  fillValues: Partial<RecruitmentCandidateCreateInput>;
...
export const mergeResumeBasicInfo = (
  currentValues: Partial<RecruitmentCandidateCreateInput>,
